/* @ts-self-types="./lemma_transform.d.ts" */
 ...
 * @param {Uint8Array} transform_code
 * @param {string} canonical_args
 * @param {string} runtime
 * @param {string | null} [prev_output_commitment]
 * @returns {string}
 */
export function bind(input_bytes, output_bytes, transform_code, canonical_args, runtime, prev_output_commitment) {
    let deferred7_0;
    let deferred7_1;
    try {
        ...
        const ptr2 = passArray8ToWasm0(transform_code, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passStringToWasm0(canonical_args, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passStringToWasm0(runtime, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len4 = WASM_VECTOR_LEN;
        var ptr5 = isLikeNone(prev_output_commitment) ? 0 : passStringToWasm0(prev_output_commitment, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len5 = WASM_VECTOR_LEN;
        const ret = wasm.bind(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5);
        deferred7_0 = ret[0];
        deferred7_1 = ret[1];
 ...
 * @returns {string}
 */
export function normalize(raw_json) {
    let deferred2_0;
    let deferred2_1;
    try {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lemma_transform_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
