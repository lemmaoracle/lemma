...
調達リスト: `Lemma_ビジネス記事カバー写真_調達リスト_v1_2026-08-04.md`
規律 §2.1「ストックフォト（ライセンス明示）か実撮影のみ」に基づく記録。
入稿仕様: 16:9 センタークロップ・幅 1600px・JPEG q74・**無加工**
（色調・ヴェール・走査線は CSS 側 — BlogArticleTemplate の `.cover--photo`）。

| ファイル | 記事 | 撮影者 | 出所 | ライセンス |
|---|---|---|---|---|
| stablecoin-payment-reconciliation.jpg | 2026.08.21 請求書の内訳は、送金に乗らない（淡い灰色のファサードに並ぶ正方形の窓 — 同じ形が延々と並び数枚だけ開いている、件数のスケール抽象。金融系カバーが暗く続いたため明るい方向に選定） | Pawel Czerwinski | https://unsplash.com/photos/KMICAjAH7fU | Unsplash License |
...
| j-alert-spoofing-origin-verification-gap.jpg | 2026.09.02 Jアラート報道が示す、「発信元証明」の不在（夕暮れの受信アンテナ — 空に向いた一基だけ、届くものの出所は写らない） | Donald Giannatti | https://unsplash.com/photos/Wj1D-qiOseE | Unsplash License |
