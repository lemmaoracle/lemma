...
- **判断（2025-06-23、部分的サマリージャッジメント）**:
  - 適法取得した書籍による学習 → **fair use**（判示原文 "exceedingly transformative"。推論部には "quintessentially transformative" の表現もある。この部分の原告 3 名の請求は却下）
...
- **手続の現況**: 2025-09-25 に Alsup 判事が予備承認。クレーム提出期限は 2026-03-30 に終了（公正性審問時点でクレーム率 92.77%・447,576 作品、timely claims の処理継続中）。最終承認のための公正性審問は 2026-05-14 に Martínez-Olguín 判事の下で実施され、判事は結審せず under submission（本ドラフト時点 2026-06-04 で Final Approval Order は未発出）。審問では弁護士報酬・費用構造が主な質疑対象で、opt-out・異議は僅少と報告された
...
- 2025-09-25: Alsup 判事による予備承認、クレーム手続開始。和解金の分割払い開始（2025-10〜2027-09 の 4 回）
- 2026-03-30: クレーム提出期限（終了。審問時点でクレーム率 92.77%・447,576 作品）
- 2026-05-14: 最終承認のための公正性審問（Martínez-Olguín 判事）。結審せず under submission。2026-06-04 時点で Final Approval Order は未発出
...
- **Authors Alliance（二次情報・審問の現況）**: "Bartz v. Anthropic Fairness Hearing: Observations and Takeaways"（2026-05-14、under submission・クレーム率 92.77%・447,576 作品）— https://www.authorsalliance.org/2026/05/14/bartz-v-anthropic-fairness-hearing-observations-and-takeaways/
