...
2024 年 1 月、国土交通省は、ある大手自動車メーカーの 3 車種について、量産車が安全基準を満たすか国が確認するための試験データに不正があったとして、出荷に必要な型式指定を取り消した。立入検査では、当初の社内報告には無かった不正が追加で見つかっている。同時期に自動車・二輪・産業用エンジンの複数メーカーで同種の不正が確認され、ある産業機械メーカーでは産業用エンジンのほぼ全型式が取り消された。いずれのケースも、メーカーが自社で実施・提出した試験データが正しいかを指定の前に独立して確かめる仕組みが無く、不正は立入検査や第三者委員会という事後の調査で初めて発覚し、その間に量産・出荷された製品はすでに市場に出ていた。本 Brief は、特定企業の断罪を目的としない。複数の製造事業者に共通して観察される構造的事象を、規制属性の独立検証という観点から分析する。個別の処分事案は公的記録として §8 に出典を示すにとどめ、本文では業種・規模の記述子で扱う。
