...
自動運転が「人間より安全」だという主張も、実際の事故データも、メーカーの自己申告のまま独立に検証されていなかった。2026 年 3 月 18 日、米 NHTSA は Tesla の FSD が視界低下（逆光・霧・砂塵）を扱えない問題の調査を、リコール前段の重い段階（約 320 万台が対象）へ引き上げ、システムがカメラの劣化を衝突直前まで警告しなかったこと、社内のデータ整理の制約で対象事故が過少に報告されていた可能性を指摘した。並行して 2026 年 5 月 28 日、Reuters は「FSD は人間より最大 10 倍安全」という主張が、不公平な比較によって安全性を実際の約 3 倍に水増ししていたと報じた。AI の走行判断と、当局や市場に示される安全性の数字が、いずれも事業者の自己申告のまま独立検証されていなかった点が核心である。
