...
title_en: "Font Forgery Made AI's Document Review Read Different Text (Noroboto) — Input-Integrity Forgery via Embedded Lying Fonts"
...
文書に細工したフォントを埋め込むことで、人間が画面で読む文章と AI が実際に読み取る文字列を別物にできる「Noroboto」という手法が公開された。契約書の金額・日付・準拠法などをこっそり書き換えれば、AI による文書レビューが人間の想定と食い違う結論を出してしまう構造で、実証テストでは一部の AI が誤った回答を返した。
