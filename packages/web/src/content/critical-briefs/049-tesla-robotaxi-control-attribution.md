...
Tesla Robotaxi の NHTSA 提出事故記録の黒塗りが外され、Austin の事故のうち 2 件は自律システムではなく遠隔操作の人間運転手が起こしたものと判明した。経緯説明は「営業秘密」として黒塗りされてきた。事故報告も規制調査も機能したが、「そのとき何が制御していたか」も記録の真正性も、運行主体の自己申告・自己黒塗りに委ねられ、外部から独立に検証できない。記録の存在は帰属の証明ではない。
...
- 2025-12: NHTSA が別途、FSD に関する予備評価（消費者苦情 58 件：赤信号無視・対向車線への逸脱等）を開始（EA26002／[Brief 043](https://lemma.frame00.com/ja/critical/briefs/043-tesla-fsd-self-reported-safety/) 圏）
...
中心的な<strong>失敗 primitive は「自律システムの走行判断と、事故時に『誰／何が制御していたか』という帰属が、行為の時点で独立検証可能な証跡として固定されておらず、事後の自己申告・自己黒塗りに依存する」</strong>であり、ここに安全性評価の前提が崩れる。
...
[Brief 043](https://lemma.frame00.com/ja/critical/briefs/043-tesla-fsd-self-reported-safety/)（自動運転の事故データと「人間より安全」の根拠が自社申告のまま独立検証されない）の隣接事案であり、同じ運行主体の、記録の来歴という別断面である。[Brief 035](https://lemma.frame00.com/ja/critical/briefs/035-boeing-787-inspection-records/)（Boeing 787 で、検査記録の存在が実施の証明と取り違えられた）と同型で、**記録の存在が、記録される事実の真正な証明ではない**構造を、自動運転の制御帰属へ移す。[Brief 012](https://lemma.frame00.com/ja/critical/briefs/012-williams-frt-wrongful-arrest/)（顔認識の AI 判定が独立検証なく行政の強制処分に直結した）とも、AI 判断が独立検証を欠いたまま安全・処分に直結する点で連なる。本事案が示すのは、自動運転という公共空間の AI 判断において、制御帰属と記録の来歴が独立検証されないことの帰結である。
