...
完全な自動運転でなくても、人間が運転する普通の市販車で AI は安全のため運転に割り込み、衝突が迫ったと判断すれば自動でブレーキをかける。だがその判断が誤れば、危険がないのに急ブレーキがかかり後続車に追突される。2026 年 5 月、Hyundai は前方カメラのソフト不具合で自動ブレーキが早すぎるタイミングで作動しうるとして、Tucson・Santa Cruz 系の 421,078 台をリコールした。寄せられた 376 件の作動報告のうち 4 件で後続車からの追突が起き、4 件の負傷が申告されている。完全自律ではなく人間と AI の判断が混ざる運転支援であるからこそ、AI を業務に組み込みつつある企業の現状に近い構図である。
