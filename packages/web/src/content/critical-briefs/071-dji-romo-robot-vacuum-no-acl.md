...
あるセキュリティ研究者が自分の DJI ROMO 掃除ロボットの通信を調べていたところ、自作のアプリを DJI のクラウドにつないだ瞬間、約 7,000 台（24 か国以上）の他人のロボットが応答し、それらのライブのカメラ映像・マイク音声・間取りデータにアクセスできる状態だった。原因は、クラウド基盤が「ログインは済んでいるか」だけを見て「この利用者は、この 1 台に対して権限を持つか」を確かめておらず、認証を通った 1 人があらゆる機体に届いてしまったことにある。研究者はメディアを通じて DJI に通報し、DJI は 2 月 8 日・10 日の更新で修正、3 万ドルの報奨金を支払った（一部の指摘は報告時点で未修正と報じられた）。
