...
gap_detected: "出力ごとのコンテンツ違反判定や権利者の事後の異議申立てで、保護対象に似た生成を止めることはできた。"
gap_missing: "「この生成は、用いる素材の権利・同意・来歴を備えるか」を生成の前に確かめる層が無く、許諾の確認が事後の拒否（opt-out）に委ねられていた。"
gap_fix: "高リスク行動の前に「この素材は、この用途に、許諾された来歴を持つ」ことを Lemma で独立検証して、事前に防ぐ。"
---

## TL;DR

2025 年 10 月、OpenAI は動画生成 AI「Sora 2」を、権利者が「やめてください」と申し出ない限り著作権キャラクターを自由に生成できる方針で公開した。許可を先に取るのではなく、嫌なら後から拒否させる——この順番の逆転により、公開直後から One Piece・鬼滅・ポケモン・マリオ等を含む大量の動画が SNS に出回り、批判が噴出した。OpenAI は公開から約 3 日で「事前に許可を取る」方式へ転換し、特定人物の生成も停止。日本の著作権団体 CODA（スタジオジブリ・バンダイナムコ・東映アニメーション等）と日本政府も、事前の許諾を求める是正を正式に要請した。生成の前に「使う素材は、この用途に許可されているか」を確かめる仕組みが無く、確認が権利者の事後の異議に委ねられていたことが問題の核心である。
