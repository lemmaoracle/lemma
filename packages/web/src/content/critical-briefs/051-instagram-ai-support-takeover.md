...
アカウントを乗っ取るのに、パスワードを破る必要はなかった。AI のサポート担当に「このアカウントのメールアドレスを変えて」と頼むだけでよかった。2026 年 5 月末、Meta は Instagram の AI 支援アカウント復旧システム（High Touch Support）に脆弱性があり、第三者に悪用されて 20,225 件のアカウントが乗っ取られたことを公表した。攻撃者は、依頼者が**そのアカウントの正当な持ち主かを AI が確かめないまま**、メールアドレス変更やパスワードリセットを実行させ、二要素認証も回避した（著名アカウントの被害・時系列は後述）。問題の構造は、AI の復旧担当が、影響の大きい操作を、**依頼者がそのアカウントの正当な持ち主だと確かめる前に**実行してしまった点にある。
