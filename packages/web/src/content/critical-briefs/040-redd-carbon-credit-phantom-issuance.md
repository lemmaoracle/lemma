...
「森林を保全し炭素を固定した」とされるカーボンクレジットが、実際には保全の実態がない土地から作られ、Nestlé・Boeing など大手企業に数百万ドル規模で販売されていた。2025 年 10 月、ブラジル連邦警察は本事案を「Operation Greenwashing」として詐欺・土地収奪の容疑で 31 名を起訴（Amazonas 州 Lábrea の REDD+ 2 事業、Unitor・Fortaleza Ituxi、計 14 万 ha 超）。乖離を最初に可視化したのは Mongabay の調査報道と CCCA の衛星画像分析だった。本 Brief は、「森林が保全され炭素が固定された」という環境属性が、根拠データ（保全面積・土地登録・伐採量）の来歴・真正性の独立検証から切り離されたままクレジット化され、自主的炭素市場と企業の排出量開示に流入する構造を、検出との役割分担の観点から分析する。
