...
検出（事後の原因特定・資金退避・補償・監査）は被害の是正に、事前証明（署名前の署名コードの来歴の独立検証）はウォレット署名の信頼確立に、それぞれ相補的に働く。設計と適用範囲は [Pillar 01 — 来歴証明](https://lemma.frame00.com/ja/pillars/#provenance) および [Seal](https://lemma.frame00.com/ja/seal/) を参照のこと。
