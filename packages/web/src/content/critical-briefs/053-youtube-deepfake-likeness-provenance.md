...
著名人になりすました AI 詐欺広告が、ある調査では約 2 億回再生され、YouTube は偽の著名人を使った広告を 1,000 件超削除した。YouTube はこれを受けて、アップロードされた動画から登録済みの顔を自動で探し出す対抗ツールを公人から全クリエイターへと広げているが、この仕組みは偽物が作られ広まった後にしか働かない。本人の顔や声が「誰の許可で使われたものか」を、動画が作られ公開される前に確かめる仕組みがそもそも無いため、偽物が先に拡散し、削除はいつも後追いになる。
