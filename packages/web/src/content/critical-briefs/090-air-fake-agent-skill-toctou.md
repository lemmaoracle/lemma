...
検出（提出時のスキャン・事後の悪性判定）は不正な成果物の発見に、事前証明（利用の時点での成果物の来歴の独立検証）はエージェントスキルの信頼確立に、それぞれ相補的に働く。設計と適用範囲は [Pillar 01 — 来歴証明](https://lemma.frame00.com/ja/pillars/#provenance) および [Seal](https://lemma.frame00.com/ja/seal/) を参照のこと。
