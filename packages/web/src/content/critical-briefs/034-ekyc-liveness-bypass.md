...
MIT Technology Review の調査で、銀行・暗号資産取引所・決済アプリが本人確認に使う「顔のライブ撮影による生体確認」を破るための既製ツールが、Telegram 上の 22 のチャネルで公然と売られていることが明らかになった。端末のカメラに偽の映像を流し込むソフト、盗まれた生体データのパッケージ、AI で作った顔の動画、アプリのカメラ機能を横取りする仕掛けなどが販売され、Binance・BBVA・Revolut 等の口座開設審査の突破を謳う。核心は、本人確認の側が「カメラに映る顔は、その場にいる本人の生体だ」と、映像の出所を確かめずに信じてしまう点にある。事前録画や AI 生成の映像を流し込めば、「頭を動かして」といった指示にも応じられ、審査を通過してしまう。
