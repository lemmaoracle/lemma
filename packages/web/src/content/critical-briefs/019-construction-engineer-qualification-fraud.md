...
2024 年 12 月、国土交通省は、ある建設会社が、必要な実務経験を満たさないまま国家資格（施工管理技士など）を取得した社員を、有資格者が必須の現場に配置していたとして行政処分を行った。先行する大手企業グループの事案では、390 名が実務経験不足のまま資格を取得し、要件を満たさない社員が最大 2,422 件の工事に配置されていた。いずれのケースも、「この技術者は本当に要件を満たす有資格者か」を配置の前に確かめる仕組みが無く、不正は十数年〜二十数年が経ってから、内部調査や行政監査で初めて発覚している。本 Brief は、特定企業の断罪を目的としない。複数の建設業者に共通して観察される構造的事象を、規制属性の独立検証という観点から分析する。個別の処分事案は公的記録として §8 に出典を示すにとどめ、本文では業種・規模の記述子で扱う。
