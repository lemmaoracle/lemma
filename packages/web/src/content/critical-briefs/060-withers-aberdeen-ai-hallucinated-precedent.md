...
弁護士が AI で下調べをして書面を作るのは、いまや珍しくない。だが 2026 年 6 月、ミシシッピ州の連邦地裁判事は、ある民事訴訟で対立する双方の弁護士が、いずれも AI が作り出した「実在しない判例」を確かめないまま裁判所に提出していたと認定し、計 4 名の弁護士を制裁して公判を取り消した。起草した弁護士 2 名は罰金と 2 年間の出廷禁止、その書面を保証して署名した地元弁護士 2 名も内容を確かめずに署名した「盲判」として制裁された。問題は弁護士が AI を使ったことではなく、AI が挙げた判例が実在するかを、書面を出すという行動の前に誰も独立に確かめなかったことにある。
