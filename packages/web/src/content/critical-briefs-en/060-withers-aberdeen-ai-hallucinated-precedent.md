...
A lawyer using AI to do preliminary research and draft a brief — that is no longer unusual. But what happens when no one checks whether the cases the AI cited actually exist before filing with the court? On June 8, 2026, Senior U.S. District Judge Sharion Aycock of the Northern District of Mississippi found that, in a civil case, **counsel on both opposing sides had each cited AI-generated cases that do not exist** in their briefs. She sanctioned four attorneys for violating Rule 11 and vacated the trial. The two out-of-state attorneys who drafted the briefs were fined and barred from the district for two years; the two local attorneys who sponsored their appearance and signed the filings were sanctioned as "rubberstamp[s]." The judge called it an unusual situation in which counsel on both sides committed the same sanctionable conduct, and found that blind reliance on the technology left each brief tainted with hallucinated citations. The issue is not "that the lawyers used AI," but that **there was no layer to independently verify — before the act of filing — that the authorities (cases) the AI surfaced actually exist and carry a legitimate origin.** We analyze this through the lens of Pillar 02 (Verifiable AI), as a structure in which the existence and provenance of the grounds for an AI output go independently unverified, and we frame it as a division of labor with detection and sanction. It connects to Brief 005 (the integrity of the input an AI reads), Brief 011 (provenance marks on AI-generated artifacts), Brief 012 (an AI determination leading directly to a legal disposition without independent verification), and Brief 017 (the layer that governs AI has neither integrity nor provenance).
