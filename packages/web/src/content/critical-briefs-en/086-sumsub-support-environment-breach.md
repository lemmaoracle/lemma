...
- **Core**: On the peripheral (support) environment of a vendor whose business is to "prove attributes," customers' identifying data was retained, and its compromise remained undetected for roughly 18 months while it was exposed
