...
Carbon credits sold as "forest conserved, carbon sequestered" were in fact generated from land with no real conservation, and sold — on the order of millions of dollars — to major corporations including Nestlé and Boeing. In October 2025, Brazil's Federal Police charged 31 people over the case as "Operation Greenwashing," alleging fraud and land-grabbing (two REDD+ projects in Lábrea, Amazonas — Unitor and Fortaleza Ituxi, together over 140,000 hectares). The divergence was first made visible by Mongabay's investigative reporting and satellite-imagery analysis by the Center for Climate Crime Analysis (CCCA). This Brief analyzes — from the standpoint of a division of labor with detection — the structure in which an environmental attribute ("the forest was conserved and carbon was sequestered") is issued as credits and flows into the voluntary carbon market and corporate emissions disclosure, severed from independent verification of the provenance and authenticity of its underlying data (conservation area, land registration, logging volume).
