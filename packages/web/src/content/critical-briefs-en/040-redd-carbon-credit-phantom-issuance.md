...
In October 2025, Brazil's Federal Police, in "Operation Greenwashing," indicted 31 people on suspicion of fraud and land-grabbing tied to Amazon REDD+ carbon-credit projects. The targets were two REDD+ projects in Lábrea, Amazonas state (Unitor and Fortaleza Ituxi, together more than 140,000 hectares). These had generated and sold credits on the basis of an environmental attribute — "the forest was conserved and carbon was sequestered" — but the Federal Police concluded that the same areas were also used as a channel to launder illegally logged timber from elsewhere. The credits had been sold, on the order of millions of dollars, to major corporations including Nestlé, Toshiba, Spotify, Boeing, and PwC. The divergence was first made visible by Mongabay's investigative reporting (May 2024) and the satellite-imagery analysis commissioned from the Center for Climate Crime Analysis (CCCA), which flagged a mismatch between the reported logging volume and the volume estimated from satellite imagery. This Brief examines the structure by which an environmental attribute — "a given forest was conserved and carbon was sequestered" — is issued as credits and flows into the voluntary carbon market and corporate emissions disclosure, severed from independent verification of the provenance and authenticity of its underlying data (conservation area, land registration, logging volume). This Brief analyzes a widely reported and investigated overseas case structurally, through the lens of independent verification of regulatory attributes. It treats the roles of certification bodies, verifiers, and detection as a division of labor, not as a target of criticism.
