...
If the proof of capture provenance does not hold, the attribute is not established, and detection is complemented by proof beforehand. Read together with [Brief 022](/critical/briefs/022-onlyfake-ai-id-kyc-bypass/) (OnlyFake) as the "looks right but the provenance is fake" lineage.
