...
References: [Proof-as-Auth: sign in without sending your key](/blog/proof-as-auth-sign-in-without-sending-your-key/) · [Verifiable Origin](/pillars/verifiable-origin/) · [Brief 047 (OpenClaw agent phishing)](/critical/briefs/047-openclaw-agent-phishing/) · [Brief 075 (Klue → Salesforce)](/critical/briefs/075-klue-oauth-salesforce-credential-lifecycle/)
