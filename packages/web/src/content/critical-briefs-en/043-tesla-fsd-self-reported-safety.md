...
On March 18, 2026, the U.S. NHTSA upgraded its investigation into Tesla's "Full Self-Driving (FSD)" inability to handle reduced visibility (sun glare, fog, airborne dust) to an Engineering Analysis (EA26002, covering 3,203,754 vehicles) — the stage immediately preceding a recall. NHTSA noted that FSD's "degradation detection" — the software meant to recognize that the cameras are not seeing properly and warn the driver — failed to function under common road conditions and did not warn until just before a collision. NHTSA further stated that, citing internal "data-labeling constraints," Tesla could not uniformly identify the relevant crashes, which may have led to **under-reporting** of the crashes in scope. Separately, Tesla has repeatedly delayed submitting FSD driving-violation data. In parallel, on May 28, 2026, Reuters reported that Tesla's claim that "FSD is up to 10× safer than humans" rested on a flawed method — comparing its own airbag-deployment crashes against all tow-away crashes in federal data (which include a lower-severity threshold) — inflating safety by roughly 3×. This Brief examines the structure in which both the AI driving decision of an autonomous vehicle and the safety attributes presented to regulators and markets (crash rate, the "safer" claim) remain self-reported by the operator and are not independently verified. This Brief analyzes a widely reported and investigated overseas case structurally, through the lens of independent verification of AI decisions and regulatory attributes. It treats the roles of regulators, investigative reporting, and detection as a division of labor, not as a target of criticism.
