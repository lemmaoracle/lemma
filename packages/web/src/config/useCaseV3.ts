...
export const USE_CASE_V3: Readonly<Record<string, UseCaseV3>> = {
  ...
  "ai-document-isolation": {
    ...
    withProof: [
      { k: "agent", v: "did:lemma:agent-contract-classifier" },
      { k: "modelId", v: "claude-3.7-sonnet" },
      { k: "policyHash", v: "0x71c5…" },
      { k: "inputCommitment", v: "0xb4e2…" },
      { k: "outputCommitment", v: "契約区分 = A", vEn: "contract tier = A", strong: true },
  ...
  "ai-audit-log-proof": {
    ...
    withProof: [
      { k: "agent", v: "did:lemma:agent-credit-reviewer" },
      { k: "modelId", v: "gpt-internal-v4" },
      { k: "policyHash", v: "0x3d90…" },
      { k: "inputCommitment", v: "0x7a2c…" },
      { k: "outputCommitment", v: "承認判断 = 規定遵守", vEn: "approval = policy-compliant", strong: true },
      { k: "satisfiesPolicy", v: "true" },
      { k: "ZK verified", v: "✓ VALID", badge: true },
    ],
    approach: {
  ...
  "kyc-aml-selective-disclosure": {
    ...
    withProof: [
      { k: "holder", v: "did:lemma:user-customer-001" },
      { k: "issuer", v: "did:lemma:authority-jp-mha" },
      { k: "jurisdiction", v: "JP" },
      { k: "licenseType", v: "kyc-attestation" },
      { k: "disclosed", v: "[age_18+, residence_JP, aml_clean]", strong: true },
      { k: "hidden", v: "[name, address, dob, passport_no]" },
      { k: "ZK verified", v: "✓ VALID", badge: true },
    ],
    approach: {
  ...
  "supply-chain-esg": {
    ...
    withProof: [
      { k: "holder", v: "did:lemma:supplier-abc-corp" },
      { k: "issuer", v: "did:lemma:authority-eu-cbam" },
      { k: "jurisdiction", v: "EU" },
      { k: "licenseType", v: "cbam-eudr-attestation" },
      { k: "disclosed", v: "[cbam_compliant, eudr_compliant, carbon_lt_1.0]", strong: true },
      { k: "hidden", v: "[contract_value, co2_intensity, invoice]" },
      { k: "lineageChain", v: "[tier3, tier2, tier1]" },
      { k: "ZK verified", v: "✓ VALID", badge: true },
    ],
    approach: {
  ...
  "rag-source-attestation": {
    ...
    withProof: [
      { k: "agent", v: "did:lemma:agent-rag-assistant" },
      { k: "modelId", v: "claude-3.7-sonnet" },
      { k: "policyHash", v: "0x5c41…" },
      { k: "outputCommitment", v: "就業規則 @ v3.2（latest）", vEn: "work-rules @ v3.2 (latest)", strong: true },
      { k: "satisfiesPolicy", v: "true" },
      { k: "sourceHash", v: "0x9b1d…" },
      { k: "lineageChain", v: "[issue, index, cite]" },
      { k: "issuer", v: "did:lemma:docs.internal" },
      { k: "ZK verified", v: "✓ VALID", badge: true },
    ],
    approach: {
  ...
  "rag-content-provenance": {
    ...
    withProof: [
      { k: "subject", v: "did:lemma:doc-policy-v3", strong: true },
      { k: "issuer", v: "did:lemma:docs.internal" },
      { k: "sourceHash", v: "0x4f8a…" },
      { k: "lineageChain", v: "[upload, index, embed]" },
      { k: "integrity", v: "poseidon-merkle" },
      { k: "ZK verified", v: "✓ VALID", badge: true },
    ],
    approach: {
      ja: "社内文書を RAG に取り込む瞬間に、原本を暗号化したうえで、文書の指紋（sourceHash）・発行者署名・有効バージョンをインデックス側に刻みます。AI が検索でヒットさせるのは原本そのものではなく、来歴を持つ事実だけ。引用された一文は、刻まれた指紋経由でどの版に由来するかを追跡でき、改訂されれば古い版の引用は構造的に検知できます。",
  ...
  "defi-bridge-verification": {
    ...
    withProof: [
      { k: "subject", v: "did:lemma:bridge-msg-eth-arb", strong: true },
      { k: "issuer", v: "did:lemma:bridge-validators" },
      { k: "sourceHash", v: "0x7e2a…" },
      { k: "lineageChain", v: "[source-finalized, relayed, verified]" },
      { k: "integrity", v: "merkle-proof" },
      { k: "ZK verified", v: "✓ VALID", badge: true },
    ],
    approach: {
  ...
  "financial-data-exfiltration": {
    ...
    withProof: [
      { k: "holder", v: "did:lemma:org-acme-finance" },
      { k: "issuer", v: "did:lemma:internal-monitor" },
      { k: "jurisdiction", v: "JP" },
      { k: "licenseType", v: "access-attestation" },
      { k: "disclosed", v: "[anomaly_rule-3, impact_segment_A]", strong: true },
      { k: "hidden", v: "[account, amount, counterparty, memo]" },
      { k: "ZK verified", v: "✓ VALID", badge: true },
    ],
    approach: {
