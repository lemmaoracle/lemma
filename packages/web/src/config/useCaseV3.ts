...
export const USE_CASE_V3: Readonly<Record<string, UseCaseV3>> = {
  ...
  "rag-source-attestation": {
    ...
    without: [
      { k: "query", v: "育児休業の申請手順は？" },
      { k: "retrieved_doc", v: "就業規則.pdf" },
      { k: "version", v: "v2.1（旧版）" },
      { k: "content", v: "本文抜粋…" },
      { k: "source", v: "社内共有ドライブ" },
    ],
    withProof: [
      { k: "claim", v: "就業規則 @ v3.2（latest）", strong: true },
      { k: "docHash", v: "0x9b1d…" },
  ...
  "rag-content-provenance": {
    ...
    withProof: [
      { k: "claim", v: "就業規則 @ v3 · 発行 docs.internal", strong: true },
      { k: "docHash", v: "0x4f8a…" },
