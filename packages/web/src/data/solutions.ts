...
export const SOLUTIONS: SolutionsContent = {
  ...
  checklist: {
    ...
    items: {
      ja: [
        "自律 AI エージェントに、経費承認・購買・支払いを任せたい",
        "RAG・社内文書 AI を、来歴の確かなデータで本番運用したい",
        "AI の入出力や動作を、内容を開示せず第三者に証明したい",
        "外部の事実確認に基づく承認・支払いを自動化したい",
      ...
      en: [
        ...
        "We want to run RAG / internal-document AI in production—on data with proven provenance.",
        "We want to prove our AI's input/output and behavior to third parties without disclosing content.",
