...
export const T402_SELL_OG: { readonly ja?: string; readonly en?: string } = {
  // JA: the delivered v9 listing card (static). EN: the product-family
  // card generated by renderTrust402SellOg (og/products/trust402/sell/en.png).
  ja: "https://lemma.frame00.com/og/products/trust402/sell-ja.png",
  en: "https://lemma.frame00.com/og/products/trust402/sell/en.png",
};
