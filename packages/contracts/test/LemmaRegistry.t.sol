...
import {LemmaRegistry} from "../contracts/LemmaRegistry.sol";
...
contract LemmaRegistryTest is Test {
    ...
    function _register() internal {
        registry.registerDocument(
            DOC_HASH, ROOT, SCHEMA_HASH, issuer, subject, REVOCATION_ROOT, _emptyHooks()
        );
    }
    ...
    function test_registerDocument_emitsDocumentRegistered() public {
        ...
        emit LemmaRegistry.DocumentRegistered(
            DOC_HASH, ROOT, SCHEMA_HASH, issuer, subject, REVOCATION_ROOT
        );
    ...
    function test_registerDocument_revertsOnZeroDocHash() public {
        ...
        registry.registerDocument(
            bytes32(0), ROOT, SCHEMA_HASH, issuer, subject, REVOCATION_ROOT, _emptyHooks()
        );
    }
