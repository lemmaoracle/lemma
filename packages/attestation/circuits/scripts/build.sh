#!/usr/bin/env bash
#
# Compile the attestation-commitment circuit and run the groth16 trusted setup.
# Prerequisite: circom + the circuits/ npm dependencies.
#
set -euo pipefail

CIRCUIT_NAME="attestation-commitment"
...
$SNARKJS zkey contribute \
  ...
  --name="lemma attestation-commitment" -v -e="lemma attestation-commitment $(date +%s)"
