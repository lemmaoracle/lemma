    ...
    [
      ...
      () => {
        ...
        return leaf === undefined
          ? poseidon.F.toObject(poseidon.F.zero)
          : leaf;
      },
    ],
    [R.T, () => {
      ...
      const pairAndHash = (level: ReadonlyArray<bigint>): bigint => {
        ...
        return R.cond([
          ...
          [R.T, () => {
            ...
            const nextLevel = R.map(
              (pair: ReadonlyArray<bigint>) => {
...
export const commitNormalized = async (
  ...
  return R.cond([
    [
      ...
      () => Promise.reject(
        new Error("Normalized data must be a non-empty object"),
      ),
    ],
    [R.T, async () => {
      ...
      return {
        ...
        perAttributeCommitments: R.map(
          (leaf: bigint) => `0x${leaf.toString(16)}`,
          leaves,
        ),
