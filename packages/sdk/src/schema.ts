...
/* eslint-disable functional/no-let, functional/immutable-data, functional/no-expression-statements --
...
/* eslint-enable functional/no-let, functional/immutable-data, functional/no-expression-statements */
