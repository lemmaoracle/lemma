#!/usr/bin/env bash
#
# Compile the content-commitment circuit and run the groth16 trusted setup.
# Prerequisite: circom + the circuits/ npm dependencies.
#
set -euo pipefail

CIRCUIT_NAME="content-commitment"
...
$SNARKJS zkey contribute \
  ...
  --name="lemma content-commitment" -v -e="lemma content-commitment $(date +%s)"
