...
const buildCircuitMeta = (wasmUrl: string, zkeyUrl: string): CircuitMeta => ({
  ...
  schema: SCHEMA,
  description:
    "Trust402 org-identity v1 — proves an institution committed a memberRoot for a domain at a timestamp (Poseidon5 commitmentHash). DNS TXT verification is off-circuit; the proof creates a verifiable registration record.",
  inputs: [
    "commitmentHash",
    "orgDid",
    "memberRoot",
